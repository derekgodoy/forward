...
<div class="container mt-5 justify-content-center bg-light col-xl-6 mb-5" style="border-radius: 10px;">
			...
			<div class="col p-0 m-0 bg-light border-top border-bottom" style="border-radius: 25px;">
				...
				<div class="row justify-content-center">
					<div class="col-10">
						<h5 class=""><a href=""><i class="far fa-heart text-muted"></i></a> <a href=""><i class="fas fa-share-alt text-muted pl-3"></i></a><a href="../home/removePost.php?id=<?php echo $post[$i]['id']; ?>" ><i class="fas fa-times text-muted float-right"></i></a></h5>
					</div>
				</div>
			</div>
			</div>
